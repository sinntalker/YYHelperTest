...
import com.sinntalker.sinntest20180503_yy.Fragment.family.util.TimeUtil;
import com.sinntalker.sinntest20180503_yy.Fragment.family.util.ViewUtil;
...
public class ConversationHolder extends BaseViewHolder {
    ...
    public void bindData(Object o) {
        ...
        //会话图标
        ViewUtil.setAvatar(conversation.getConversationIcon(), R.drawable.avatar, iv_recent_avatar);
        //会话标题
