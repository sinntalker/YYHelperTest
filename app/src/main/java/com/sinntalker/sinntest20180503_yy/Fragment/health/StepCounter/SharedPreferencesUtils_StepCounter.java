...
public class SharedPreferencesUtils_StepCounter {
    ...
    public SharedPreferencesUtils_StepCounter(String FILE_NAME) {
        this.FILE_NAME = FILE_NAME;

    }
    public SharedPreferencesUtils_StepCounter(Context context) {
